...
class SignUpPasswordTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle,
        ...
        self.item.isSecureTextEntry = true
        self.item.accessibilityLabel = "Password"
        super.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: "SignUpPasswordTableViewCell")
