...
class SignUpEmailTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle,
        ...
        self.item.accessibilityLabel = "Email"
        super.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: "SignUpEmailTableViewCell")
