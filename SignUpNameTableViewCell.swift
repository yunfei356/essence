...
class SignUpNameTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle,
        ...
        self.item.accessibilityLabel = "Name"
        super.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: "SignUpNameTableViewCell")
