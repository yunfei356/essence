//
//  ProfileBirthDateTableViewCell.swift
//  zhiyouios
//
//  Created by Yun Fei Guo on 2018-11-03.
//  Copyright © 2018 Yun Fei Guo. All rights reserved.
//

import UIKit

class ProfileBirthDateTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle,
        ...
        super.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: "ProfileBirthDateTableViewCell")
        self.item.addTarget(self, action: #selector(datePickerValueChanged(sender:)), for: UIControl.Event.valueChanged)
        self.item.isUserInteractionEnabled = false
