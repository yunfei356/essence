//
//  SignUpPhoneTableViewCell.swift
//  zhiyouios
//
...
class SignUpPhoneTableViewCell: UITableViewCell {
    ...
    override init(style: UITableViewCell.CellStyle,
        ...
        super.init(style: UITableViewCell.CellStyle.default, reuseIdentifier: "SignUpPhoneTableViewCell")
